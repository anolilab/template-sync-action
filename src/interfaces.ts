...
export interface IGithubManagerBranch {
    create: (owner: string, repo: string, sha: string, syncBranch: string) => Promise<void>;
...
export interface IGithubManagerPulls {
    create: (owner: string, repo: string, head: string, base: string, title: string, body: string) => Promise<void>;
}
...
export interface IGithubManagerRepos {
    ...
    downloadRepository: (owner: string, repo: string, ref: string) => Promise<void>;
}
